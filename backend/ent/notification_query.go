...
func (nq *NotificationQuery) QueryRecipient() *UsersQuery {
	query := (&UsersClient{config: nq.config}).Query()
...
func (nq *NotificationQuery) WithRecipient(opts ...func(*UsersQuery)) *NotificationQuery {
	query := (&UsersClient{config: nq.config}).Query()
