...
func (cc *CareersCreate) AddStudentIDs(ids ...int) *CareersCreate {
	cc.mutation.AddStudentIDs(ids...)
	return cc
}

// AddStudents adds the "students" edges to the Student entity.
func (cc *CareersCreate) AddStudents(s ...*Student) *CareersCreate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
...
func (cc *CareersCreate) AddSubjectIDs(ids ...int) *CareersCreate {
	cc.mutation.AddSubjectIDs(ids...)
	return cc
}

// AddSubjects adds the "subjects" edges to the Subject entity.
func (cc *CareersCreate) AddSubjects(s ...*Subject) *CareersCreate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
