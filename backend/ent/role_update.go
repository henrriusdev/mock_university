...
func (ru *RoleUpdate) AddUsers(u ...*Users) *RoleUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
func (ru *RoleUpdate) RemoveUsers(u ...*Users) *RoleUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
// AddUsers adds the "users" edges to the Users entity.
func (ruo *RoleUpdateOne) AddUsers(u ...*Users) *RoleUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
// RemoveUsers removes "users" edges to Users entities.
func (ruo *RoleUpdateOne) RemoveUsers(u ...*Users) *RoleUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
