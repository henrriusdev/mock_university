<script>
  ...
  /**
   * @typedef {import("bits-ui").CalendarProps} CalendarProps
   * @typedef {import("bits-ui").CalendarEvents} CalendarEvents
   */

  /** @type {CalendarProps["value"]} */
  export let value = undefined;

  /** @type {CalendarProps["placeholder"]} */
  export let placeholder = today(getLocalTimeZone());

  /** @type {CalendarProps["weekdayFormat"]} */
